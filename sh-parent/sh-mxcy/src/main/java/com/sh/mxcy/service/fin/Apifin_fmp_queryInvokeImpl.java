 ...
 * @description 半成品非毛坯-查询
 */
@Service("Apifin_fmp_queryInvokeImpl")
public class Apifin_fmp_queryInvokeImpl implements ServiceHandlerInvoke {
    ...
    public RetJSONObject handler(JSONObject inParamJO) throws Exception {
        ...
        List<OutDBJSONObject> outDBJSONObject = FinDao.fmp_query(inDBJSONObject);
