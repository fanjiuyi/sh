 ...
 * @description 生产计划--修改
 */
@Service("Apiplan_editInvokeImpl")
public class Apiplan_editInvokeImpl implements ServiceHandlerInvoke {
    ...
    public RetJSONObject handler(JSONObject inParamJO) throws Exception {
        ...
        if (ret.isSuccess()) {
            //参数复制
            HandlePubDataUtil.paramCopy(inParamJO, inDBJSONObject, "id", "name", "plan_num", "figure_no", "order_num", "start_time", "end_time", "type_code", "week_num", "day_num","me_type_code", "remarks");
